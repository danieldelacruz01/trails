exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('checkpoints2').insert({chkId:20, locationName: 'Logical core', description:'devs live here',latitude:-41.297342, longitude: 174.774296,imgUrl: 'http://wellington.scoop.co.nz/wp-content/uploads/2010/09/plaatje11.jpg',timeLimit:100, distanceInMetres:094, hint:'Here there and back again', trailId:2})
 );
};
